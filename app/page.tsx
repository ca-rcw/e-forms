...
const forms = [
  ...
  { code: "F-TGN-002", title: "Thesis Title Approval Sheet", description: "Submit a proposed thesis title for review and approval.", category: "Advising & Approval", status: "Available", href: "/forms/f-tgn-002.html", icon: ClipboardCheck },
  { code: "F-TGN-003", title: "Application for Outline/Final Examination", description: "Apply for the thesis outline or final examination schedule.", category: "Examination", status: "Available", href: "/forms/f-tgn-003.html", icon: GraduationCap },
  { code: "F-TGN-004", title: "Minutes of Thesis Defense", description: "Record the proceedings, recommendations, and decisions of the thesis defense.", category: "Examination", status: "Available", href: "/forms/f-tgn-004.html", icon: NotebookPen },
  { code: "F-TGN-005", title: "Defense Evaluation Form", description: "Evaluate the student’s thesis presentation and defense performance.", category: "Examination", status: "Available", href: "/forms/f-tgn-005.html", icon: FileCheck2 },
  { code: "F-TGN-006", title: "Result of Examination for Defense", description: "Document the official result of the thesis defense examination.", category: "Examination", status: "Available", href: "/forms/f-tgn-006.html", icon: ClipboardCheck },
  { code: "F-TGN-007A", title: "Thesis Outline Processing Form", description: "Track the evaluation and approval of the thesis outline.", category: "Processing", status: "Available", href: "/forms/f-tgn-007a.html", icon: FileSearch },
  { code: "F-TGN-007B", title: "Thesis Manuscript Processing Form", description: "Track the review and final acceptance of the thesis manuscript.", category: "Processing", status: "Available", href: "/forms/f-tgn-007b.html", icon: FileSearch },
